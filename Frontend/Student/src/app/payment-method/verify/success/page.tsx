...
export default function EsewaVerifySuccessPage() {
  ...
  useEffect(() => {
    ...
    // In a full implementation, call backend to verify status using refId, pid
    // then mark the payment method as verified.
  }, []);
