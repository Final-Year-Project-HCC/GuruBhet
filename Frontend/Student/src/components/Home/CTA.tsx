    ...
    <section className="bg-primary text-primary-foreground py-24">
      <div className="max-w-7xl mx-auto px-4 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button className="bg-white text-primary px-10 py-5 rounded-2xl font-bold text-lg hover:scale-[1.02] transition-transform shadow-xl">
            Explore All Tutors
          </button>
          <button className="border border-white/20 bg-white/10 px-10 py-5 rounded-2xl font-bold text-lg hover:bg-white/20 transition-colors">
            Apply to Teach
          </button>
        </div>
