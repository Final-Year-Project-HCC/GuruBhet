    ...
    <div className="bg-surface">
      ...
      >
        {LEVELS.map((level) => (
          <div 
            key={level.id} 
            className="min-w-50 bg-muted/40 hover:bg-muted p-6 rounded-2xl border border-border scroll-snap-align-start transition-all cursor-pointer group"
          >
            <div className="w-12 h-12 bg-surface rounded-xl flex items-center justify-center mb-4 shadow-sm border border-border group-hover:scale-110 transition-transform">
