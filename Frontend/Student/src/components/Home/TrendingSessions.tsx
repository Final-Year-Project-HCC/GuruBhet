  ...
  return (
    ...
    >
      {TRENDING_TEACHERS.map((teacher) => (
        <div 
          key={teacher.id} 
          className="min-w-[260px] sm:min-w-[280px] group cursor-pointer scroll-snap-align-start bg-white border border-border rounded-2xl p-4 hover:shadow-lg transition-all"
        >
          ...
          <div className="relative aspect-[16/10] rounded-xl overflow-hidden mb-4 shadow-sm">
            ...
            <div className="absolute top-2 right-2">
              <div className="bg-white/95 backdrop-blur px-2 py-1 rounded-lg shadow-sm border border-border flex items-center gap-1">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-start gap-2">
              ...
              {teacher.verification_status === 'APPROVED' && (
                <div className="text-blue-500 flex-shrink-0" title="Verified Professional">
